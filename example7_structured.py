...
async def main()->None:
    ...
    movie_review_agent = AssistantAgent(
        ...
        system_message = """You are a professional movie reviewer agent.You must analyze only given  movie thoroughly and 
    ...
    print("----Movie review----")
    movie_result = await movie_review_agent.run(task = f"Review {movie} Movie")
